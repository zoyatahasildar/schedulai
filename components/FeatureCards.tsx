...
const FEATURES: Feature[] = [
  {
    ...
    desc: "Set your weekly schedule once. EdOra handles timezone conversions automatically.",
    theme: "#3b82f6",
  ...
  },
  {
    ...
    desc: "Send automatic email reminders to reduce no-shows and keep everyone aligned.",
    theme: "#8b5cf6",
  ...
  },
  {
    ...
    desc: "Get detailed reports summarizing your bookings, peak hours, and productivity.",
    theme: "#14b8a6",
